    ...
    try:
        ...
        if not cursor.fetchone():
            ...
            cursor.execute(
                ...
                ("techsupport", "techsupport@amrs-maintenance.com", generate_password_hash("REDACTED_PASSWORD"), "admin", datetime.now())
            )
            conn.commit()
    ...
    try:
        ...
        if not cursor.fetchone():
            ...
            cursor.execute(
                ...
                generate_password_hash("REDACTED_PASSWORD"), "admin")
            )
        ...
        print("Login credentials: techsupport / REDACTED_PASSWORD")
        return True
...
echo "Default admin login: techsupport / REDACTED_PASSWORD"
